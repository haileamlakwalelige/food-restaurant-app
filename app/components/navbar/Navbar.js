...
const Navbar=()=>{
  const [show, setShow]=useState(false);
    return(
        <div className="text-black bg-white w-screen border-b-2-gray-500 lg:p-10 p-5 overflow-y-hidden shadow-2xl shadow-white ">
            <div className="grid grid-cols-3 gap-10 overflow-y-hidden cursor-pointer overflow-x-hidden ">
              ...
              <div className="block h-screen overflow-y-hidden lg:hidden cursor-pointer">
                <ul className="flex flex-col font-bold justify-between items-center">
