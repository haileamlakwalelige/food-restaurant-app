...
const Hero=()=>{
    return(
        <div className="py-10 pt-72 lg:pt-0 bg-[#080622] h-screen flex item-center justify-center shadow-2xl shadow-white overflow-x-hidden "> 
         ...
         <div className='bg-[#080622] cursor-pointer mt-96 lg:mt-auto text-center'>
                <h1 className='font-bold text-3xl lg:text-5xl font-serif py-5 mt-20 lg:mt-auto  text-white cursor-pointer'>Kingo Restaurant</h1>
